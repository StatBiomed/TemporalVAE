...
class SuperviseVanillaVAE_regressionClfDecoder_removerBatchEffectDecoder(BaseVAE):
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        super(SuperviseVanillaVAE_regressionClfDecoder_removerBatchEffectDecoder, self).__init__()
        ...
        self.clf_input = nn.Linear(self.latent_dim - self.batchEffect_dim, hidden_dims[0])
