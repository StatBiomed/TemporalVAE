...
class SuperviseVanillaVAE_regressionClfDecoder_of_subLatentSpace(BaseVAE):
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        super(SuperviseVanillaVAE_regressionClfDecoder_of_subLatentSpace, self).__init__()
        ...
        # Build classifier
        self.clf_input = nn.Linear(10, 10)
        self.clf_decoder = nn.Sequential(nn.Linear(10, 5),
                                         nn.BatchNorm1d(5),
                                         nn.Sigmoid(),
                                         nn.Linear(5, 1))
