...
class SuperviseVanillaVAE_discreteLabel_Joy(BaseVAE):
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        super(SuperviseVanillaVAE_discreteLabel_Joy, self).__init__()
    ...
    def loss_function(self,
        ...
        clf_loss = clf_weight * F.cross_entropy(reclf, label.type(torch.cuda.LongTensor))
