...
class SuperviseVanillaVAE_regressionClfDecoder_mouse_batchDecoder(BaseVAE):
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        super(SuperviseVanillaVAE_regressionClfDecoder_mouse_batchDecoder, self).__init__()
        ...
        self.batchEffect_decoder = nn.Sequential(nn.Linear(hidden_dims[0], hidden_dims[0]),
                                                 ...
                                                 nn.BatchNorm1d(hidden_dims[0]),
                                                 nn.Tanh(),
                                                 nn.Linear(hidden_dims[0], self.batch_num),  # 2023-10-06 15:49:29
                                                 nn.Sigmoid())
    ...
    def loss_function(self,
        ...
        loss = recons_loss + kld_weight * kld_loss + clf_weight * clf_loss-batch_weight*batch_loss
        return {'loss': loss, 'Reconstruction_loss': recons_loss.detach(), 'KLD': -kld_loss.detach(), "clf_loss": clf_loss,"batch_loss":batch_loss}
