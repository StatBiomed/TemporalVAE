...
class SuperviseVanillaVAE_regressionClfDecoder_mouse_noAdversarial_u_s_focusEncoder_moreFeatures(BaseVAE):
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        super(SuperviseVanillaVAE_regressionClfDecoder_mouse_noAdversarial_u_s_focusEncoder_moreFeatures, self).__init__()
    ...
    def encode(self, input: Tensor) -> List[Tensor]:
        ...
        result = self.encoder(self.encoder_input(input))
    ...
    def forward(self, input: Tensor, **kwargs) -> List[Tensor]:
        ...
        temp = self.encoder._modules["0"](self.encoder_input(spliced_data))
        # temp = self.encoder._modules["0"](spliced_data)
        unspliced_data = self.encoder_input(unspliced_data)
