...
class VAEXperiment_fineTune_u_s_focusDecoder(pl.LightningModule):
    def __init__(self,
                 vae_model: BaseVAE,
                 params: dict) -> None:
        super(VAEXperiment_fineTune_u_s_focusDecoder, self).__init__()
    ...
    def train(self, mode=True):
        super(VAEXperiment_fineTune_u_s_focusDecoder, self).train(mode=mode)
    ...
    def predict_step(self, batch, batch_idx, optimizer_idx=0):
        ...
        test_loss = self.model.loss_function(*results,
                                             ...
                                             optimizer_idx=optimizer_idx,
                                             batch_idx=batch_idx)
        # if results[0][0].shape[1] != results[1][0].shape[1]:  # 2023-06-29 18:27:01 for noCLF decoder vae
