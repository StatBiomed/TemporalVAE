...
"""
@Project ：TemporalVAE 
@File    ：starts_exps_mouse_plotLatentSpace_trainOnStereoAndAtlas_withAdversarial.py
@IDE     ：PyCharm 
@Author  ：awa121
...
source ~/.bashrc
nohup python -u project_mouse_Yijun/starts_exps_mouse_plotLatentSpace_trainOnStereoAndAtlas_withAdversarial.py >> logs/starts_exps_mouse_plotLatentSpace_trainOnStereoAndAtlas_withAdversarial.log 2>&1 &
...
def main():
    ...
    min_gene_num = 100
    result_save_path = f"/231119_plotLatentSpace_trainOnStereoAndAltas_minGeneNum{min_gene_num}_withAdversarial/"
    vae_param_file_list_re = [
        ...
        "supervise_vae_regressionclfdecoder_adversarial0121212_231001_06_gamma2.yaml"
    ]
