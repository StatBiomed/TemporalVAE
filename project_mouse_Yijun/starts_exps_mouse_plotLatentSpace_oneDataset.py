...
"""
@Project ：TemporalVAE 
@File    ：starts_exps_mouse_plotLatentSpace_oneDataset.py
@IDE     ：PyCharm 
@Author  ：awa121
...
source ~/.bashrc
nohup python -u project_mouse_Yijun/starts_exps_mouse_plotLatentSpace_oneDataset.py >> logs/starts_exps_mouse_plotLatentSpace.log 2>&1 &
"""
import os, sys
import time
import yaml
...
def main():
    ...
    dataset_list = [
        ...
        # "/mouse_embryo_stereo/preprocess_Mouse_embryo_all_stage_minGene50_hvgAll_ofLiver/",
        # "/mouse_embryo_stereo/preprocess_Mouse_embryo_all_stage_minGene50_hvgAll_ofHeart/",
        # "/mouse_embryo_stereo/preprocess_Mouse_embryo_all_stage_minGene50_hvgAll_ofBrain/",
    ...
    # min_gene_num_list = [100, 75, 50]
    min_gene_num_list = [50]
    epoch_num = 100
    batch_size = 100000
    python_file = "project_mouse_Yijun/VAE_mouse_plotLatentSpace_oneDataset.py"
    time_type_list_re = ["embryoneg5to5"]

    result_save_path = f"231124_plotLatentSpace_mouse_data_minGene50_timeCorGene_batchsize{batch_size}_epoch{epoch_num}"
    # -------------------------------------------------------------------------------------------------------------------
    cmd_list = []
        ...
        for vae_param_file in vae_param_file_list_re:
            for dataset in dataset_list:
                for min_gene_num in min_gene_num_list:
                    ...
                    cmd = cmd + f" > logs/{log_file_name} 2>&1 &"
                    cmd_list.append(cmd)
