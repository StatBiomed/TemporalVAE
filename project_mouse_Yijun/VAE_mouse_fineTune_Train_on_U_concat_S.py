...
"""
@Project ：TemporalVAE 
@File    ：VAE_mouse_fineTune_Train_on_U_concat_S.py
@IDE     ：PyCharm 
@Author  ：awa121
...
def main():
    ...
    #               clf_weight=clf_weight, hvg_dic=hvg_dic)
    cal_new_adata(adata_concated, gene_dic, mouse_atlas_file, f"{save_result_path}/all/", config_file, checkpoint_file, fine_tune_mode=fine_tune_mode,
