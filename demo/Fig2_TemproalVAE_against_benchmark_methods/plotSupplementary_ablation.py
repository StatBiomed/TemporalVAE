...
def plot_boxAndDot_on_allData(temporalVAE_df,vae_df,
    ...
    plt.savefig(f"demo/Fig2_TemproalVAE_against_benchmark_methods/{dataset}_temporalVAEvsVAE_boxAndDot_results.png", dpi=200)
...
def plot_kFold_corr(temporalVAE_df,vae_df,
    ...
    plt.tight_layout(rect=[0, 0, 1, 0.95])
    plt.savefig(f"demo/Fig2_TemproalVAE_against_benchmark_methods/{dataset}_temporalVAEvsVAE_results.png", dpi=200)
