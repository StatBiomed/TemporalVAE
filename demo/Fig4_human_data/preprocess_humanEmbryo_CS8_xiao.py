...
from TemporalVAE.utils import calHVG_adata as calHVG
from TemporalVAE.utils import draw_venn,plot_data_quality


def main(select_hvg_bool = False):
    hvg_num = 1000
    file_path = "data/human_embryo_preimplantation/XiaoCS8/"
    human_hvg_gene_list=pd.read_csv("data//human_embryo_preimplantation/Melania_5datasets/gene_info.csv",
                                    sep='\t',index_col=0)
